  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <TiltCard className="md:col-span-3 transition-all duration-300 h-[200px]">
          <div className="glass-card h-full rounded-[40px] bg-white/10 backdrop-blur-md border border-white/20">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-8 h-full">
              <div className="md:col-span-2 flex gap-6">
                ...
                <div className="flex-1 flex flex-col justify-between h-full">
                  <div>
                    <h2 className="text-4xl font-black text-white mb-2">Aidan Dombrowski</h2>
        ...
        <TiltCard className="md:col-span-2 transition-all duration-300 h-[632px]">
          <div className="glass-card h-full rounded-[40px] bg-white/10 backdrop-blur-md border border-white/20">
            <div className="p-8 h-full flex flex-col">
              <h3 className="text-4xl font-black text-white mb-6">Projects</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-2 flex-1 relative">
                {/* Vertical divider */}
                ...
                <Link href="/iron-pillar" className="p-6 flex flex-col justify-center cursor-pointer transition-all duration-300 hover:bg-white/5 hover:shadow-[0_0_20px_rgba(200,255,150,0.4)] rounded-2xl group">
                  <h4 className="text-2xl font-bold text-white mb-3 group-hover:text-[#C8FF96] group-hover:drop-shadow-[0_0_8px_rgba(200,255,150,0.6)] transition-all">Iron Pillar</h4>
                ...
                <Link href="/whiskey-thief" className="p-6 flex flex-col justify-center cursor-pointer transition-all duration-300 hover:bg-white/5 hover:shadow-[0_0_20px_rgba(200,255,150,0.4)] rounded-2xl group">
                  <h4 className="text-2xl font-bold text-white mb-3 group-hover:text-[#C8FF96] group-hover:drop-shadow-[0_0_8px_rgba(200,255,150,0.6)] transition-all">Whiskey Thief</h4>
                ...
                <Link href="/lego-architect" className="p-6 flex flex-col justify-center cursor-pointer transition-all duration-300 hover:bg-white/5 hover:shadow-[0_0_20px_rgba(200,255,150,0.4)] rounded-2xl group">
                  <h4 className="text-2xl font-bold text-white mb-3 group-hover:text-[#C8FF96] group-hover:drop-shadow-[0_0_8px_rgba(200,255,150,0.6)] transition-all">LEGO Architect</h4>
                ...
                <Link href="/multiverse-mix" className="p-6 flex flex-col justify-center cursor-pointer transition-all duration-300 hover:bg-white/5 hover:shadow-[0_0_20px_rgba(200,255,150,0.4)] rounded-2xl group">
                  <h4 className="text-2xl font-bold text-white mb-3 group-hover:text-[#C8FF96] group-hover:drop-shadow-[0_0_8px_rgba(200,255,150,0.6)] transition-all">Multiverse Mix</h4>
        ...
        <div className="md:col-span-1 flex flex-col gap-4">
          <Link href="/demo-reel">
            <TiltCard className="transition-all duration-300 h-[200px]">
              <div className="glass-card h-full rounded-[40px] bg-white/10 backdrop-blur-md border border-white/20">
                <div className="p-8 flex items-start h-full">
                  <h3 className="text-3xl font-black text-white">Demo Reel</h3>
                </div>
              </div>
            </TiltCard>
          </Link>
          <Link href="/gallery">
            <TiltCard className="transition-all duration-300 h-[200px]">
              <div className="glass-card h-full rounded-[40px] bg-white/10 backdrop-blur-md border border-white/20">
                <div className="p-8 flex items-start h-full">
                  <h3 className="text-3xl font-black text-white">Gallery</h3>
                </div>
              </div>
            </TiltCard>
          </Link>
          <Link href="/about">
            <TiltCard className="transition-all duration-300 h-[200px]">
              <div className="glass-card h-full rounded-[40px] bg-white/10 backdrop-blur-md border border-white/20">
                <div className="p-8 flex items-start h-full">
                  <h3 className="text-3xl font-black text-white">About Me</h3>
                </div>
              </div>
            </TiltCard>
          </Link>
