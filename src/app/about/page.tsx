...
export default function AboutPage() {
  return (
    <>
            ...
            <ScrollReveal>
              <div className="relative">
                <Image
                  ...
                  width={400}
                  height={400}
                  className="rounded-2xl object-cover w-full max-w-sm sm:max-w-md mx-auto lg:mx-0"
                  priority
                />
              </div>
            </ScrollReveal>
      ...
      {/* Education Section */}
      <section className="py-16 sm:py-20 lg:py-28 bg-white/50 border-t border-stone-200/60">
        <Container className="px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <div>
              ...
              <ScrollReveal delay={100}>
                <Card padding="lg">
                  <CardContent>
                    <h3 className="text-xl sm:text-2xl font-semibold text-[var(--color-text-primary)] mb-1">
                      {education.degree}
                    </h3>
                    <p className="text-[var(--color-accent)] text-sm sm:text-base mb-2">
                      {education.school}
                    </p>
                    <p className="text-[var(--color-text-secondary)] text-sm sm:text-base mb-2">
                  ...
                  <CardContent>
                    <div className="flex flex-col md:flex-row md:items-start gap-2 sm:gap-4">
                      <div className="flex-1">
                        <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-[var(--color-text-primary)] mb-1">
                          {exp.title}
                        </h3>
                        <p className="text-[var(--color-accent)] text-sm sm:text-base mb-2 sm:mb-3">
                          {exp.company}
                        </p>
                        <ul className="space-y-1.5 sm:space-y-2 list-disc list-inside marker:text-[var(--color-accent)]">
                          {exp.description.map((item, i) => (
                            <li key={i} className="text-[var(--color-text-secondary)] text-xs sm:text-sm">
                              {item}
                            </li>
                          ))}
                        </ul>
                      </div>
                      <div className="text-[var(--color-text-secondary)] text-xs sm:text-sm md:text-right whitespace-nowrap order-first md:order-last mb-2 md:mb-0">
                        {exp.period}
                      </div>
                    </div>
                  </CardContent>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            <ScrollReveal delay={0}>
              <Card padding="lg" hover>
                <CardContent>
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[var(--color-accent)]/10 rounded-lg flex items-center justify-center mb-3 sm:mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-[var(--color-text-primary)] mb-2">UX/UI Design</h3>
            ...
            <ScrollReveal delay={100}>
              <Card padding="lg" hover>
                <CardContent>
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-[var(--color-text-primary)] mb-2">Motion Design</h3>
                  <p className="text-[var(--color-text-secondary)] text-xs sm:text-sm">
            ...
            <ScrollReveal delay={200}>
              <Card padding="lg" hover>
                <CardContent>
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-[var(--color-text-primary)] mb-2">Brand Identity</h3>
                  <p className="text-[var(--color-text-secondary)] text-xs sm:text-sm">
