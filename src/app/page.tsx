...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="py-28 relative overflow-hidden dither-bg dark-section">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {skillCategories.map((skillCat, index) => (
                  <ScrollReveal key={skillCat.category} delay={index * 50}>
                    <GlassSurface className="p-5 h-full" hover>
                      <h3 className="text-[var(--color-text-primary)] font-semibold text-base mb-3">
                        {skillCat.category}
                      </h3>
      ...
      {/* CTA Section */}
      <section className="py-32 relative overflow-hidden border-t border-stone-200/60">
        {/* Background gradient */}
        <div className="absolute inset-0 bg-gradient-to-b from-stone-100/70 to-stone-200/50" />

        <Container size="md" className="relative z-10">
          <ScrollReveal className="text-center">
            <h2 className="text-[var(--text-display)] font-black uppercase tracking-tight mb-6">
              Let's Work
              <br />
              <span className="text-[var(--color-text-secondary)]">Together</span>
            </h2>
            <p className="text-[var(--color-text-secondary)] text-lg mb-10 max-w-lg mx-auto">
